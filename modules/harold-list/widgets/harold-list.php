...
?>
	...
	protected function render() {
		...
		$this->add_render_attribute(
			[
				'upk-harold-list' => [
					'class' => 'upk-harold-list upk-ajax-grid',
					'data-loadmore' => [
						wp_json_encode(
							array_filter([
		...
		$this->add_render_attribute('list-wrap', 'class', 'upk-list-wrap upk-ajax-grid-wrap');
	...
	?>
		<div <?php $this->print_render_attribute_string('upk-harold-list'); ?>>
