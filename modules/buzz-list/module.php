...
class Module extends Ultimate_Post_Kit_Module_Base {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_nopriv_upk_buzz_list_loadmore_posts', [ $this, 'callback_ajax_loadmore_posts' ] );
		add_action( 'wp_ajax_upk_buzz_list_loadmore_posts', [ $this, 'callback_ajax_loadmore_posts' ] );
	}
	...
	public function callback_ajax_loadmore_posts() {
		...
		if ( $ajaxposts->have_posts() ) {
			...
			while ( $ajaxposts->have_posts() ) {
				...
				?>
				<div <?php if ( ! empty( $settings['global_link'] ) && $settings['global_link'] === 'yes' ) { printf( 'onclick="window.open(\'%s\', \'_self\')"', esc_url( $post_link ) ); } ?> class="upk-item upk-flex upk-flex-middle">
